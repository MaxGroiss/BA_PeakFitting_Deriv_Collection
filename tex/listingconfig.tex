...
\lstdefinelanguage[RISC-V]{Assembler}
{
  ...
  alsodigit={0x, 0x1B}, % hex numbers are numbers too!
  morekeywords=[1]{ % instructions
    ...
    j, jr, jal, jalr, ret,
    scall, break, nop, OS_DECLARE_EMULATED_INSTRUCTION, OS_TASKENTRY, asm, cinsi, cinsi_emu
  },
...
\lstset{
  ...
  frame=shadowbox,
  rulesepcolor=\color{black!50!white},
  %language=[RISC-V]Assembler,                   % all code is RISC-V
  tabsize=2,                                    % indent tabs with 2 spaces
...
\lstdefinelanguage{json}{
    ...
    morestring=[b]",
    morestring=[b]',
    stringstyle=\ttfamily\bfseries\color{jsoncomment},
}
